...
# Unit tests for SwaggerClient::ChannelsChannelsGlobalApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ChannelsChannelsGlobalApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ChannelsChannelsGlobalApi.new
  end
  ...
  describe 'test an instance of ChannelsChannelsGlobalApi' do
    it 'should create an instact of ChannelsChannelsGlobalApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ChannelsChannelsGlobalApi)
    end
  end
