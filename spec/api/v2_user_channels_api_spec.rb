...
# Unit tests for SwaggerClient::V2UserChannelsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'V2UserChannelsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::V2UserChannelsApi.new
  end
  ...
  describe 'test an instance of V2UserChannelsApi' do
    it 'should create an instact of V2UserChannelsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::V2UserChannelsApi)
    end
  end
