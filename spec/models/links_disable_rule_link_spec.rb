...
# Unit tests for SwaggerClient::LinksDisableRuleLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksDisableRuleLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksDisableRuleLink.new
  end
  ...
  describe 'test an instance of LinksDisableRuleLink' do
    it 'should create an instact of LinksDisableRuleLink' do
