...
# Unit tests for SwaggerClient::LinksUpdateRuleLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksUpdateRuleLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksUpdateRuleLink.new
  end
  ...
  describe 'test an instance of LinksUpdateRuleLink' do
    it 'should create an instact of LinksUpdateRuleLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksUpdateRuleLink)
    end
  end
