...
# Unit tests for SwaggerClient::LinksExportOrdersLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksExportOrdersLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksExportOrdersLink.new
  end
  ...
  describe 'test an instance of LinksExportOrdersLink' do
    it 'should create an instact of LinksExportOrdersLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksExportOrdersLink)
    end
  end
