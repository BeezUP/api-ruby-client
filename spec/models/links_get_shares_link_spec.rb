...
# Unit tests for SwaggerClient::LinksGetSharesLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksGetSharesLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksGetSharesLink.new
  end
  ...
  describe 'test an instance of LinksGetSharesLink' do
    it 'should create an instact of LinksGetSharesLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksGetSharesLink)
    end
  end
