...
# Unit tests for SwaggerClient::LinksSavePersonalInfoLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksSavePersonalInfoLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksSavePersonalInfoLink.new
  end
  ...
  describe 'test an instance of LinksSavePersonalInfoLink' do
    it 'should create an instact of LinksSavePersonalInfoLink' do
