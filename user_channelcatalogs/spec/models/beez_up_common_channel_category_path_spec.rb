...
# Unit tests for SwaggerClient::BeezUPCommonChannelCategoryPath
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BeezUPCommonChannelCategoryPath' do
  before do
    # run before each test
    @instance = SwaggerClient::BeezUPCommonChannelCategoryPath.new
  end
  ...
  describe 'test an instance of BeezUPCommonChannelCategoryPath' do
    it 'should create an instact of BeezUPCommonChannelCategoryPath' do
      expect(@instance).to be_instance_of(SwaggerClient::BeezUPCommonChannelCategoryPath)
    end
  end
end
