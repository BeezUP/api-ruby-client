...
*SwaggerClient::ContractsApi* | [**get_contracts_links**](docs/ContractsApi.md#get_contracts_links) | **GET** /v2/user/customer/contracts | Get contracts links
*SwaggerClient::ContractsApi* | [**get_current_contract**](docs/ContractsApi.md#get_current_contract) | **GET** /v2/user/customer/contracts/current | Get the conditions of your current contract
*SwaggerClient::ContractsApi* | [**get_next_contract**](docs/ContractsApi.md#get_next_contract) | **GET** /v2/user/customer/contracts/next | Get the conditions of your next contract
...
## Documentation for Models
 ...
 - [SwaggerClient::ChangeOrderResponse](docs/ChangeOrderResponse.md)
