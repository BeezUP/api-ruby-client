...
------------- | ------------- | -------------
[**get_order_list_full**](ListApi.md#get_order_list_full) | **POST** /list/full | Get a paginated list of all Orders with all Order and Order Item(s) properties
[**get_order_list_light**](ListApi.md#get_order_list_light) | **POST** /list/light | Get a paginated list of all Orders without details
