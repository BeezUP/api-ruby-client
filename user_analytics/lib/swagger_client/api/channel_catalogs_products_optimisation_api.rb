...
module SwaggerClient
  class ChannelCatalogsProductsOptimisationApi
    ...
    def disable_channel_catalog_product_with_http_info(channel_catalog_id, product_id, opts = {})
      ...
      # resource path
      local_var_path = "/{channelCatalogId}/products/{productId}/disable".sub('{format}','json').sub('{' + 'channelCatalogId' + '}', channel_catalog_id.to_s).sub('{' + 'productId' + '}', product_id.to_s)
    ...
    def reenable_channel_catalog_product_with_http_info(channel_catalog_id, product_id, opts = {})
      ...
      # resource path
      local_var_path = "/{channelCatalogId}/products/{productId}/reenable".sub('{format}','json').sub('{' + 'channelCatalogId' + '}', channel_catalog_id.to_s).sub('{' + 'productId' + '}', product_id.to_s)
