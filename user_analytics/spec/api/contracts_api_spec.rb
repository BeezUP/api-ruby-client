...
describe 'ContractsApi' do
  ...
  # unit tests for get_contracts_links
  # Get contracts links
  # 
  # @param [Hash] opts the optional parameters
  # @return [Array<BeezUPCommonLink2>]
  describe 'get_contracts_links test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_current_contract
  # Get the conditions of your current contract
  # 
  # @param [Hash] opts the optional parameters
  # @return [ContractInfo]
  describe 'get_current_contract test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_next_contract
  # Get the conditions of your next contract
  # 
  # @param [Hash] opts the optional parameters
  # @return [ContractInfo]
  describe 'get_next_contract test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
