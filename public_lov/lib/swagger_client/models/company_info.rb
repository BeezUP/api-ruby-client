...
module SwaggerClient
  ...
  class CompanyInfo
    ...
    attr_accessor :accounting_emails
    ...
    def self.swagger_types
      {
        ...
        :'postal_code' => :'PostalCode',
        :'city' => :'City',
        :'country_iso_code_alpha3' => :'BeezUPCommonCountryIsoCodeAlpha3',
        :'company' => :'Company',
        :'vat_number' => :'VatNumber',
        :'accounting_emails' => :'AccountingEmails'
      }
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'accountingEmails')
        self.accounting_emails = attributes[:'accountingEmails']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          accounting_emails == o.accounting_emails
    end
    ...
    def hash
      [address, postal_code, city, country_iso_code_alpha3, company, vat_number, accounting_emails].hash
    end
