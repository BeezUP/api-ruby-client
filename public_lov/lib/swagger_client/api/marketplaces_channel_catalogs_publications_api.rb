...
module SwaggerClient
  class MarketplacesChannelCatalogsPublicationsApi
    ...
    def get_publications_with_http_info(marketplace_technical_code, account_id, opts = {})
      ...
      # resource path
      local_var_path = "/publications/{marketplaceTechnicalCode}/{accountId}/history".sub('{format}','json').sub('{' + 'marketplaceTechnicalCode' + '}', marketplace_technical_code.to_s).sub('{' + 'accountId' + '}', account_id.to_s)
