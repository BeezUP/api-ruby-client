  ...
  class RightsApi
    ...
    def get_rights_with_http_info(store_id, functionality_code_list, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: RightsApi.get_rights ..."
      end
      # verify the required parameter 'store_id' is set
      fail ArgumentError, "Missing the required parameter 'store_id' when calling RightsApi.get_rights" if store_id.nil?
      # verify the required parameter 'functionality_code_list' is set
      fail ArgumentError, "Missing the required parameter 'functionality_code_list' when calling RightsApi.get_rights" if functionality_code_list.nil?
      # resource path
      local_var_path = "/stores/{storeId}/rights".sub('{format}','json').sub('{' + 'storeId' + '}', store_id.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RightsApi#get_rights\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
