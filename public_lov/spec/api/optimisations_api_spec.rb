...
# Unit tests for SwaggerClient::OptimisationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OptimisationsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::OptimisationsApi.new
  end
  ...
  describe 'test an instance of OptimisationsApi' do
    it 'should create an instact of OptimisationsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::OptimisationsApi)
    end
  end
