...
# Unit tests for SwaggerClient::MarketplaceBusinessCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MarketplaceBusinessCode' do
  before do
    # run before each test
    @instance = SwaggerClient::MarketplaceBusinessCode.new
  end
  ...
  describe 'test an instance of MarketplaceBusinessCode' do
    it 'should create an instact of MarketplaceBusinessCode' do
      expect(@instance).to be_instance_of(SwaggerClient::MarketplaceBusinessCode)
    end
  end
end
