...
# Unit tests for SwaggerClient::LinksDeleteReportFilterLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksDeleteReportFilterLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksDeleteReportFilterLink.new
  end
  ...
  describe 'test an instance of LinksDeleteReportFilterLink' do
    it 'should create an instact of LinksDeleteReportFilterLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksDeleteReportFilterLink)
    end
  end
