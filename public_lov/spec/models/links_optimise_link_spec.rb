...
# Unit tests for SwaggerClient::LinksOptimiseLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksOptimiseLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksOptimiseLink.new
  end
  ...
  describe 'test an instance of LinksOptimiseLink' do
    it 'should create an instact of LinksOptimiseLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksOptimiseLink)
    end
  end
