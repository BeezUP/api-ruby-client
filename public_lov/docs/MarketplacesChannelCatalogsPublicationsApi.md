...
------------- | ------------- | -------------
[**get_publications**](MarketplacesChannelCatalogsPublicationsApi.md#get_publications) | **GET** /publications/{marketplaceTechnicalCode}/{accountId}/history | Fetch the publication history for an account, sorted by descending start date
