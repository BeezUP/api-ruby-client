...
module SwaggerClient
  class AutoApi
    ...
    def auto_configure_auto_import_interval_with_http_info(store_id, request, opts = {})
      ...
      # resource path
      local_var_path = "/{storeId}/autoImport/scheduling/interval".sub('{format}','json').sub('{' + 'storeId' + '}', store_id.to_s)
    ...
    def auto_delete_auto_import_with_http_info(store_id, opts = {})
      ...
      # resource path
      local_var_path = "/{storeId}/autoImport".sub('{format}','json').sub('{' + 'storeId' + '}', store_id.to_s)
    ...
    def auto_pause_auto_import_with_http_info(store_id, opts = {})
      ...
      # resource path
      local_var_path = "/{storeId}/autoImport/pause".sub('{format}','json').sub('{' + 'storeId' + '}', store_id.to_s)
    ...
    def auto_resume_auto_import_with_http_info(store_id, opts = {})
      ...
      # resource path
      local_var_path = "/{storeId}/autoImport/resume".sub('{format}','json').sub('{' + 'storeId' + '}', store_id.to_s)
    ...
    def auto_schedule_auto_import_with_http_info(store_id, request, opts = {})
      ...
      # resource path
      local_var_path = "/{storeId}/autoImport/scheduling/schedules".sub('{format}','json').sub('{' + 'storeId' + '}', store_id.to_s)
    ...
    def auto_start_auto_import_with_http_info(store_id, opts = {})
      ...
      # resource path
      local_var_path = "/{storeId}/autoImport/start".sub('{format}','json').sub('{' + 'storeId' + '}', store_id.to_s)
