...
module SwaggerClient
  ...
  class OfferLinks
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'createContract')
        self.create_contract = attributes[:'createContract']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          create_contract == o.create_contract
    end
