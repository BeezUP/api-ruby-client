...
describe SwaggerClient::Configuration do
  ...
  before(:each) do
    ...
    #require 'URI'
    #uri = URI.parse("https://api.beezup.com/v2/user/marketplaces/channelcatalogs")
  ...
  describe '#base_url' do
    it 'should have the default value' do
      ...
      #expect(config.base_url).to eq("https://api.beezup.com/v2/user/marketplaces/channelcatalogs")
    end
