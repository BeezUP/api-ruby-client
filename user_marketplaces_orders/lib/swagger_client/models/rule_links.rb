...
module SwaggerClient
  ...
  class RuleLinks
    ...
    attr_accessor :moveup

    attr_accessor :movedown
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'moveup')
        self.moveup = attributes[:'moveup']
      end

      if attributes.has_key?(:'movedown')
        self.movedown = attributes[:'movedown']
      end
      ...
      if attributes.has_key?(:'reportFilter')
        self.report_filter = attributes[:'reportFilter']
      end
    ...
    def hash
      [_self, run, delete, moveup, movedown, enable, disable, update, report_filter].hash
    end
