...
# Unit tests for SwaggerClient::MarketplaceTechnicalCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MarketplaceTechnicalCode' do
  before do
    # run before each test
    @instance = SwaggerClient::MarketplaceTechnicalCode.new
  end
  ...
  describe 'test an instance of MarketplaceTechnicalCode' do
    it 'should create an instact of MarketplaceTechnicalCode' do
      expect(@instance).to be_instance_of(SwaggerClient::MarketplaceTechnicalCode)
    end
  end
end
