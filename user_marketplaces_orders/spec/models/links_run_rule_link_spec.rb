...
# Unit tests for SwaggerClient::LinksRunRuleLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksRunRuleLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksRunRuleLink.new
  end
  ...
  describe 'test an instance of LinksRunRuleLink' do
    it 'should create an instact of LinksRunRuleLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksRunRuleLink)
    end
  end
