...
# Unit tests for SwaggerClient::BeezUPCommonInfoSummaries
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BeezUPCommonInfoSummaries' do
  before do
    # run before each test
    @instance = SwaggerClient::BeezUPCommonInfoSummaries.new
  end
  ...
  describe 'test an instance of BeezUPCommonInfoSummaries' do
    it 'should create an instact of BeezUPCommonInfoSummaries' do
      expect(@instance).to be_instance_of(SwaggerClient::BeezUPCommonInfoSummaries)
    end
  end
