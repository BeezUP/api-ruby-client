...
------------- | ------------- | -------------
[**get_store_alerts**](AlertsApi.md#get_store_alerts) | **GET** /v2/user/customer/stores/{storeId}/alerts | Get store&#39;s alerts
[**save_store_alert**](AlertsApi.md#save_store_alert) | **PUT** /v2/user/customer/stores/{storeId}/alerts/{alertId} | Save store alert
