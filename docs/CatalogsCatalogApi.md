...
[**catalog_get_product**](CatalogsCatalogApi.md#catalog_get_product) | **GET** /user/catalogs/{storeId}/products/{productId} | Get product
[**catalog_get_products**](CatalogsCatalogApi.md#catalog_get_products) | **POST** /user/catalogs/{storeId}/products | Get product list
...
begin
  ...
  puts "Exception when calling CatalogsCatalogApi->catalog_get_product: #{e}"
end
```
