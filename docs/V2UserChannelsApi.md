# SwaggerClient::V2UserChannelsApi

All URIs are relative to *https://api.beezup.comv2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_channel_categories**](V2UserChannelsApi.md#get_channel_categories) | **GET** /v2/user/channels/{channelId}/categories | Get channel categories
[**get_channel_columns**](V2UserChannelsApi.md#get_channel_columns) | **POST** /v2/user/channels/{channelId}/columns | Get channel columns
[**get_channel_info**](V2UserChannelsApi.md#get_channel_info) | **GET** /v2/user/channels/{channelId} | Get channel information
[**get_current_channels**](V2UserChannelsApi.md#get_current_channels) | **GET** /v2/user/channels/ | List all available channel for this store
...
api_instance = SwaggerClient::V2UserChannelsApi.new
...
begin
  ...
  puts "Exception when calling V2UserChannelsApi->get_channel_categories: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling V2UserChannelsApi->get_channel_columns: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling V2UserChannelsApi->get_channel_info: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling V2UserChannelsApi->get_current_channels: #{e}"
end
```
