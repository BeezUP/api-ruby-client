...
module SwaggerClient
  class SharesApi
    ...
    def delete_share_with_http_info(store_id, user_id, opts = {})
      ...
      # resource path
      local_var_path = "/stores/{storeId}/shares/{userId}".sub('{format}','json').sub('{' + 'storeId' + '}', store_id.to_s).sub('{' + 'userId' + '}', user_id.to_s)
    ...
    def get_shares_with_http_info(store_id, opts = {})
      ...
      # resource path
      local_var_path = "/stores/{storeId}/shares".sub('{format}','json').sub('{' + 'storeId' + '}', store_id.to_s)
