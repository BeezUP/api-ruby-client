...
module SwaggerClient
  class MarketplacesChannelCatalogsSettingsApi
    ...
    def get_channel_catalog_marketplace_properties_with_http_info(channel_catalog_id, opts = {})
      ...
      # resource path
      local_var_path = "/{channelCatalogId}/properties".sub('{format}','json').sub('{' + 'channelCatalogId' + '}', channel_catalog_id.to_s)
    ...
    def get_channel_catalog_marketplace_settings_with_http_info(channel_catalog_id, opts = {})
      ...
      # resource path
      local_var_path = "/{channelCatalogId}/settings".sub('{format}','json').sub('{' + 'channelCatalogId' + '}', channel_catalog_id.to_s)
