...
# Unit tests for SwaggerClient::ExclusionFilterName
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExclusionFilterName' do
  before do
    # run before each test
    @instance = SwaggerClient::ExclusionFilterName.new
  end
  ...
  describe 'test an instance of ExclusionFilterName' do
    it 'should create an instact of ExclusionFilterName' do
      expect(@instance).to be_instance_of(SwaggerClient::ExclusionFilterName)
    end
  end
end
