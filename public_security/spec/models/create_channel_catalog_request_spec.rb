...
# Unit tests for SwaggerClient::CreateChannelCatalogRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateChannelCatalogRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateChannelCatalogRequest.new
  end
  ...
  describe 'test an instance of CreateChannelCatalogRequest' do
    it 'should create an instact of CreateChannelCatalogRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateChannelCatalogRequest)
    end
  end
