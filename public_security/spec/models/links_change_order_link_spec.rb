...
# Unit tests for SwaggerClient::LinksChangeOrderLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksChangeOrderLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksChangeOrderLink.new
  end
  ...
  describe 'test an instance of LinksChangeOrderLink' do
    it 'should create an instact of LinksChangeOrderLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksChangeOrderLink)
    end
  end
