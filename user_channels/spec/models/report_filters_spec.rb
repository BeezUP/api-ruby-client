...
# Unit tests for SwaggerClient::ReportFilters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReportFilters' do
  before do
    # run before each test
    @instance = SwaggerClient::ReportFilters.new
  end
  ...
  describe 'test an instance of ReportFilters' do
    it 'should create an instact of ReportFilters' do
      expect(@instance).to be_instance_of(SwaggerClient::ReportFilters)
    end
  end
