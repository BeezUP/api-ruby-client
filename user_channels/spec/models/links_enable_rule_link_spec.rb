...
# Unit tests for SwaggerClient::LinksEnableRuleLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LinksEnableRuleLink' do
  before do
    # run before each test
    @instance = SwaggerClient::LinksEnableRuleLink.new
  end
  ...
  describe 'test an instance of LinksEnableRuleLink' do
    it 'should create an instact of LinksEnableRuleLink' do
      expect(@instance).to be_instance_of(SwaggerClient::LinksEnableRuleLink)
    end
  end
