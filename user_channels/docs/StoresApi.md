...
------------- | ------------- | -------------
[**create_store**](StoresApi.md#create_store) | **POST** /v2/user/customer/stores | Create a new store
[**delete_store**](StoresApi.md#delete_store) | **DELETE** /v2/user/customer/stores/{storeId} | Delete a store
[**get_store**](StoresApi.md#get_store) | **GET** /v2/user/customer/stores/{storeId} | Get store&#39;s information
[**get_stores**](StoresApi.md#get_stores) | **GET** /v2/user/customer/stores | Get store list
[**update_store**](StoresApi.md#update_store) | **PATCH** /v2/user/customer/stores/{storeId} | Update some store&#39;s information.
