...
module SwaggerClient
  ...
  class ChannelInfoKeyNumbers
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stores')
        self.stores = attributes[:'stores']
      end

      if attributes.has_key?(:'viewsPerMonth')
        self.views_per_month = attributes[:'viewsPerMonth']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          stores == o.stores &&
          views_per_month == o.views_per_month
    end
    ...
    def hash
      [products, categories, stores, views_per_month].hash
    end
