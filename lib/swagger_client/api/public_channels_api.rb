...
module SwaggerClient
  class PublicChannelsApi
    ...
    def get_channels_with_http_info(country_iso_code, accept_encoding, opts = {})
      ...
      # resource path
      local_var_path = "/BeezUP/public_channels/2.0/{countryIsoCode}".sub('{format}','json').sub('{' + 'countryIsoCode' + '}', country_iso_code.to_s)
    ...
    def get_channels_by_country(opts = {})
      data, _status_code, _headers = get_channels_by_country_with_http_info(opts)
      return data
    end
    ...
    def get_channels_by_country_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: PublicChannelsApi.get_channels_by_country ..."
      end
      # resource path
      local_var_path = "/BeezUP/public_channels/2.0/".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PublicChannelsApi#get_channels_by_country\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
