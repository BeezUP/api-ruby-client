  ...
  class CustomerFriendsApi
    ...
    def get_friend_info_with_http_info(user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CustomerFriendsApi.get_friend_info ..."
      end
      # verify the required parameter 'user_id' is set
      fail ArgumentError, "Missing the required parameter 'user_id' when calling CustomerFriendsApi.get_friend_info" if user_id.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CustomerFriendsApi#get_friend_info\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
