...
module SwaggerClient
  ...
  class InputConfiguration
    ...
    attr_accessor :transform_file_url
    ...
    def self.swagger_types
      {
        ...
        :'files' => :'Array<InputFileConfiguration>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'transformFileUrl')
        self.transform_file_url = attributes[:'transformFileUrl']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          transform_file_url == o.transform_file_url &&
          files == o.files
    end
