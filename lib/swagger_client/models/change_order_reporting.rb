...
module SwaggerClient
  ...
  class ChangeOrderReporting
    ...
    attr_accessor :change_order_type
    ...
    def self.swagger_types
      {
        :'execution_uuid' => :'ExecutionUUID',
        :'change_order_type' => :'BusinessOperationType',
        :'source_type' => :'SourceType',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'changeOrderType')
        self.change_order_type = attributes[:'changeOrderType']
      end
      ...
      if attributes.has_key?(:'testMode')
        self.test_mode = attributes[:'testMode']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          change_order_type == o.change_order_type &&
    ...
    def hash
      [execution_uuid, change_order_type, source_type, source_user_id, source_user_name, creation_utc_date, processing_status, last_update_utc_date, error_message, ip_address, test_mode, details].hash
    end
