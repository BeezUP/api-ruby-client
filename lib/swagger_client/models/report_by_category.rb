...
module SwaggerClient
  ...
  class ReportByCategory
    attr_accessor :catalog_category_id

    attr_accessor :catalog_category_path

    # The enabled product count for this category
    attr_accessor :enabled_product_count

    # The catalog product count related to this category
    attr_accessor :catalog_product_count
    ...
    def self.swagger_types
      {
        :'catalog_category_id' => :'BeezUPCommonCatalogCategoryId',
        :'catalog_category_path' => :'BeezUPCommonCatalogCategoryPath',
        :'enabled_product_count' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'catalogCategoryId')
        self.catalog_category_id = attributes[:'catalogCategoryId']
      end

      if attributes.has_key?(:'catalogCategoryPath')
        self.catalog_category_path = attributes[:'catalogCategoryPath']
      end

      if attributes.has_key?(:'enabledProductCount')
        self.enabled_product_count = attributes[:'enabledProductCount']
      end

      if attributes.has_key?(:'catalogProductCount')
        self.catalog_product_count = attributes[:'catalogProductCount']
      end
    ...
    def list_invalid_properties
      ...
      if @catalog_category_id.nil?
        invalid_properties.push("invalid value for 'catalog_category_id', catalog_category_id cannot be nil.")
      end

      if @enabled_product_count.nil?
        invalid_properties.push("invalid value for 'enabled_product_count', enabled_product_count cannot be nil.")
      end

      if @catalog_product_count.nil?
        invalid_properties.push("invalid value for 'catalog_product_count', catalog_product_count cannot be nil.")
      end
    ...
    def valid?
      return false if @catalog_category_id.nil?
      return false if @enabled_product_count.nil?
      return false if @catalog_product_count.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          catalog_category_id == o.catalog_category_id &&
          catalog_category_path == o.catalog_category_path &&
          enabled_product_count == o.enabled_product_count &&
          catalog_product_count == o.catalog_product_count &&
    ...
    def hash
      [catalog_category_id, catalog_category_path, enabled_product_count, catalog_product_count, click_count, cost, order_count, turn_over, margin, performance_indicator, links].hash
    end
