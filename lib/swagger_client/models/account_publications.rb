...
module SwaggerClient
  ...
  class AccountPublications
    ...
    def self.swagger_types
      {
        ...
        :'publications' => :'Array<PublicationReporting>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'publications')
    ...
    def list_invalid_properties
      ...
      if @publications.nil?
        invalid_properties.push("invalid value for 'publications', publications cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @publications.nil?
      return true
    end
