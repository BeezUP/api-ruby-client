...
module SwaggerClient
  ...
  class Category
    ...
    def self.swagger_types
      {
        :'category_id' => :'BeezUPCommonCatalogCategoryId',
    ...
    def list_invalid_properties
      ...
      if @category_path.nil?
        invalid_properties.push("invalid value for 'category_path', category_path cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @category_path.nil?
      return true
    end
    ...
    def hash
      [category_id, category_path].hash
    end
