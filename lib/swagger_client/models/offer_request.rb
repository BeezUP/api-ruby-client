...
module SwaggerClient
  ...
  class OfferRequest
    ...
    def list_invalid_properties
      ...
      if @billing_period_in_month.nil?
        invalid_properties.push("invalid value for 'billing_period_in_month', billing_period_in_month cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @billing_period_in_month.nil?
      return true
    end
    ...
    def hash
      [offer_id, store_count, coupon_discount_code, coupon_offer_code, billing_period_in_month].hash
    end
