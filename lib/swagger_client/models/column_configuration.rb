...
module SwaggerClient
  ...
  class ColumnConfiguration
    ...
    def self.swagger_types
      {
        ...
        :'custom_configuration' => :'ColumnCustomConfiguration'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'customConfiguration')
        self.custom_configuration = attributes[:'customConfiguration']
      end
    ...
    def hash
      [beez_up_column_name, custom_configuration].hash
    end
