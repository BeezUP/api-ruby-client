...
module SwaggerClient
  ...
  class ReportAdvancedFilters
    ...
    def list_invalid_properties
      ...
      if !@global_margin_percent.nil? && @global_margin_percent > 100
        invalid_properties.push("invalid value for 'global_margin_percent', must be smaller than or equal to 100.")
      end

      if !@global_margin_percent.nil? && @global_margin_percent < 0
        invalid_properties.push("invalid value for 'global_margin_percent', must be greater than or equal to 0.")
      end
      ...
      if !@link_click_to_order_max_day.nil? && @link_click_to_order_max_day > 180
        invalid_properties.push("invalid value for 'link_click_to_order_max_day', must be smaller than or equal to 180.")
      end

      if !@link_click_to_order_max_day.nil? && @link_click_to_order_max_day < 0
        invalid_properties.push("invalid value for 'link_click_to_order_max_day', must be greater than or equal to 0.")
      end
    ...
    def valid?
      ...
      return false if !@global_margin_percent.nil? && @global_margin_percent > 100
      return false if !@global_margin_percent.nil? && @global_margin_percent < 0
      return false if @link_click_to_order_type.nil?
      return false if !@link_click_to_order_max_day.nil? && @link_click_to_order_max_day > 180
      return false if !@link_click_to_order_max_day.nil? && @link_click_to_order_max_day < 0
    ...
    # @param [Object] global_margin_percent Value to be assigned
    def global_margin_percent=(global_margin_percent)

      if !global_margin_percent.nil? && global_margin_percent > 100
        fail ArgumentError, "invalid value for 'global_margin_percent', must be smaller than or equal to 100."
      end

      if !global_margin_percent.nil? && global_margin_percent < 0
        fail ArgumentError, "invalid value for 'global_margin_percent', must be greater than or equal to 0."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] link_click_to_order_max_day Value to be assigned
    def link_click_to_order_max_day=(link_click_to_order_max_day)

      if !link_click_to_order_max_day.nil? && link_click_to_order_max_day > 180
        fail ArgumentError, "invalid value for 'link_click_to_order_max_day', must be smaller than or equal to 180."
      end

      if !link_click_to_order_max_day.nil? && link_click_to_order_max_day < 0
        fail ArgumentError, "invalid value for 'link_click_to_order_max_day', must be greater than or equal to 0."
      end

      @link_click_to_order_max_day = link_click_to_order_max_day
    end
