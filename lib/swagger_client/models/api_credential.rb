...
module SwaggerClient
  ...
  class ApiCredential
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'primaryToken')
        self.primary_token = attributes[:'primaryToken']
      end

      if attributes.has_key?(:'secondaryToken')
        self.secondary_token = attributes[:'secondaryToken']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          primary_token == o.primary_token &&
          secondary_token == o.secondary_token
    end
    ...
    def hash
      [product_name, primary_token, secondary_token].hash
    end
