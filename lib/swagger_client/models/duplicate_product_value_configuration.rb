...
module SwaggerClient
  ...
  class DuplicateProductValueConfiguration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'compareOptions')
    ...
    def list_invalid_properties
      ...
      if @compare_options.nil?
        invalid_properties.push("invalid value for 'compare_options', compare_options cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @compare_options.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          strategy == o.strategy &&
          compare_options == o.compare_options
    end
