...
module SwaggerClient
  ...
  class ChannelInfoDetails
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'businessModel')
        self.business_model = attributes[:'businessModel']
      end

      if attributes.has_key?(:'channelType')
        self.channel_type = attributes[:'channelType']
      end
      ...
      if attributes.has_key?(:'subscriptionLink')
        self.subscription_link = attributes[:'subscriptionLink']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          category == o.category &&
          home_url == o.home_url &&
          subscription_link == o.subscription_link
    end
    ...
    def hash
      [costs, business_model, channel_type, category, home_url, subscription_link].hash
    end
