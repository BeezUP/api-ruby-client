...
module SwaggerClient
  ...
  class ChannelCatalog
    ...
    def hash
      [enabled, is_marketplace, channel_catalog_id, channel_id, channel_name, store_id, general_settings, cost_settings, column_mappings, exclusion_filters, export_url, status, links].hash
    end
