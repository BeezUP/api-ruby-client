...
module SwaggerClient
  ...
  class OrderHistory
    ...
    attr_accessor :change_order_reportings

    attr_accessor :harvest_order_reportings
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'changeOrderReportings')
        if (value = attributes[:'changeOrderReportings']).is_a?(Array)
          self.change_order_reportings = value
        end
      end

      if attributes.has_key?(:'harvestOrderReportings')
        if (value = attributes[:'harvestOrderReportings']).is_a?(Array)
          self.harvest_order_reportings = value
        end
      end

      if attributes.has_key?(:'lastModificationUtcDate')
