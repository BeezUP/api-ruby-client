...
module SwaggerClient
  ...
  class ClickIncludedAndVariablePrice
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'variablePrice')
        self.variable_price = attributes[:'variablePrice']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          variable_price == o.variable_price
    end
    ...
    def hash
      [click_included, variable_price].hash
    end
