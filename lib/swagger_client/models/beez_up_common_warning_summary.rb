...
module SwaggerClient
  ...
  class BeezUPCommonWarningSummary
    ...
    attr_accessor :warning_arguments
    ...
    def self.swagger_types
      {
        ...
        :'warning_code' => :'String',
        :'warning_arguments' => :'Hash<String, String>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'warningCode')
        self.warning_code = attributes[:'warningCode']
      end

      if attributes.has_key?(:'warningArguments')
        if (value = attributes[:'warningArguments']).is_a?(Array)
          self.warning_arguments = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          warning_arguments == o.warning_arguments
    end
    ...
    def hash
      [technical_error_message, warning_message, warning_code, warning_arguments].hash
    end
