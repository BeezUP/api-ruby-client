...
module SwaggerClient
  ...
  class AutomaticTransitionInfo
    ...
    attr_accessor :order_status_transition_id

    attr_accessor :enabled

    attr_accessor :marketplace_business_code

    attr_accessor :beez_up_order_status

    attr_accessor :business_operation_type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'orderStatusTransitionId')
        self.order_status_transition_id = attributes[:'orderStatusTransitionId']
      end
      ...
      if attributes.has_key?(:'beezUPOrderStatus')
        self.beez_up_order_status = attributes[:'beezUPOrderStatus']
      end

      if attributes.has_key?(:'businessOperationType')
        self.business_operation_type = attributes[:'businessOperationType']
      end
    ...
    def list_invalid_properties
      ...
      if @order_status_transition_id.nil?
        invalid_properties.push("invalid value for 'order_status_transition_id', order_status_transition_id cannot be nil.")
      end
      ...
      if @beez_up_order_status.nil?
        invalid_properties.push("invalid value for 'beez_up_order_status', beez_up_order_status cannot be nil.")
      end

      if @business_operation_type.nil?
        invalid_properties.push("invalid value for 'business_operation_type', business_operation_type cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @order_status_transition_id.nil?
      return false if @enabled.nil?
      return false if @marketplace_business_code.nil?
      return false if @beez_up_order_status.nil?
      return false if @business_operation_type.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          order_status_transition_id == o.order_status_transition_id &&
          enabled == o.enabled &&
          marketplace_business_code == o.marketplace_business_code &&
          beez_up_order_status == o.beez_up_order_status &&
          business_operation_type == o.business_operation_type &&
          links == o.links
    end
    ...
    def hash
      [marketplace_technical_code, account_id, order_status_transition_id, enabled, marketplace_business_code, beez_up_order_status, business_operation_type, links].hash
    end
