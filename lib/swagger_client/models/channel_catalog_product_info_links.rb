...
module SwaggerClient
  ...
  class ChannelCatalogProductInfoLinks
    ...
    def self.swagger_types
      {
        :'override' => :'BeezUPCommonLink2',
        :'disable' => :'BeezUPCommonLink2',
        :'reenable' => :'BeezUPCommonLink2'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reenable')
        self.reenable = attributes[:'reenable']
      end
    ...
    def hash
      [override, disable, reenable].hash
    end
