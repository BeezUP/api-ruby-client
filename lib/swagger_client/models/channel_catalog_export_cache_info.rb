...
module SwaggerClient
  ...
  class ChannelCatalogExportCacheInfo
    ...
    attr_accessor :last_content_change_utc_date
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastContentChangeUtcDate')
        self.last_content_change_utc_date = attributes[:'lastContentChangeUtcDate']
      end
    ...
    def list_invalid_properties
      ...
      if @cache_status.nil?
        invalid_properties.push("invalid value for 'cache_status', cache_status cannot be nil.")
      end
    ...
    def valid?
      return false if @cache_status.nil?
      return true
    end
