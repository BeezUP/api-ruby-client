...
module SwaggerClient
  ...
  class ReportByDayRequest
    ...
    def self.swagger_types
      {
        :'channel_ids' => :'Array<BeezUPCommonChannelId>',
        :'product_id' => :'BeezUPCommonProductId',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'channelIds')
        if (value = attributes[:'channelIds']).is_a?(Array)
    ...
    def hash
      [channel_ids, product_id, catalog_category_id, begin_period_utc_date, end_period_utc_date, advanced_filters].hash
    end
