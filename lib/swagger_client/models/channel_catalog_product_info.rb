...
module SwaggerClient
  ...
  class ChannelCatalogProductInfo
    ...
    def self.swagger_types
      {
        ...
        :'excluded' => :'BOOLEAN',
        :'excluded_by' => :'Array<ExclusionFilterName>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'excludedBy')
        if (value = attributes[:'excludedBy']).is_a?(Array)
          self.excluded_by = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @category_mapped.nil?
        invalid_properties.push("invalid value for 'category_mapped', category_mapped cannot be nil.")
      end
    ...
    def hash
      [product_id, product_sku, product_title, product_image_url, product_active, overrides, disabled, category_mapped, excluded, excluded_by, links].hash
    end
