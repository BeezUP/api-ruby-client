...
module SwaggerClient
  ...
  class CostSettings
    ...
    attr_accessor :global_cost_value
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'globalCostValue')
        self.global_cost_value = attributes[:'globalCostValue']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          global_cost_value == o.global_cost_value
    end
    ...
    def hash
      [cost_type, global_cost_value].hash
    end
