...
module SwaggerClient
  ...
  class RegisterRequest
    ...
    attr_accessor :commercial_owner_user_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'commercialOwnerUserId')
        self.commercial_owner_user_id = attributes[:'commercialOwnerUserId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          commercial_owner_user_id == o.commercial_owner_user_id
    end
    ...
    def hash
      [email, password, culture_name, commercial_owner_user_id].hash
    end
