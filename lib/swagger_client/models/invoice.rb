...
module SwaggerClient
  ...
  class Invoice
    ...
    def list_invalid_properties
      ...
      if @amount_to_be_paid.nil?
        invalid_properties.push("invalid value for 'amount_to_be_paid', amount_to_be_paid cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @amount_to_be_paid.nil?
    ...
    def hash
      [invoice_date, contract_id, invoice_number, amount, amount_to_be_paid, currency_code, payment_status, due_date, invoice_url].hash
    end
