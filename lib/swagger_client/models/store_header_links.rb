...
module SwaggerClient
  ...
  class StoreHeaderLinks
    attr_accessor :_self

    attr_accessor :delete_store

    attr_accessor :update_store
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deleteStore')
        self.delete_store = attributes[:'deleteStore']
      end

      if attributes.has_key?(:'updateStore')
        self.update_store = attributes[:'updateStore']
      end

      if attributes.has_key?(:'getShares')
