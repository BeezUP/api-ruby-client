...
module SwaggerClient
  ...
  class CreditCardInfoResponse
    ...
    attr_accessor :current_payment_method
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'currentPaymentMethod')
        self.current_payment_method = attributes[:'currentPaymentMethod']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          links == o.links &&
          current_payment_method == o.current_payment_method &&
    ...
    def hash
      [links, current_payment_method, credit_card_info, info].hash
    end
