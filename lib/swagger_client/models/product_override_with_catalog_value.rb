...
module SwaggerClient
  ...
  class ProductOverrideWithCatalogValue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'catalogValue')
        self.catalog_value = attributes[:'catalogValue']
      end
