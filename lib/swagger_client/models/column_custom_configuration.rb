...
module SwaggerClient
  ...
  class ColumnCustomConfiguration
    attr_accessor :column_importance

    attr_accessor :column_data_type

    attr_accessor :column_culture_name

    attr_accessor :column_format
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'columnCultureName')
        self.column_culture_name = attributes[:'columnCultureName']
      end

      if attributes.has_key?(:'columnFormat')
        self.column_format = attributes[:'columnFormat']
      end
    ...
    def list_invalid_properties
      ...
      if @column_data_type.nil?
        invalid_properties.push("invalid value for 'column_data_type', column_data_type cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @column_data_type.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          column_culture_name == o.column_culture_name &&
          column_format == o.column_format &&
    ...
    def hash
      [column_importance, column_data_type, column_culture_name, column_format, can_be_truncated, display_group_name].hash
    end
