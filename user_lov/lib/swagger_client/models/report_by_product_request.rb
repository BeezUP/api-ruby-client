  ...
  class ReportByProductRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'productColumnsToDisplay')
        if (value = attributes[:'productColumnsToDisplay']).is_a?(Array)
          self.product_columns_to_display = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @product_state.nil?
        invalid_properties.push("invalid value for 'product_state', product_state cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @product_state.nil?
      return true
    end
