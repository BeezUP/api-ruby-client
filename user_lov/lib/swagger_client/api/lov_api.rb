  ...
  class LOVApi
    ...
    def get_user_list_names_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LOVApi.get_user_list_names ..."
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LOVApi#get_user_list_names\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_user_list_of_values_with_http_info(list_name, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LOVApi.get_user_list_of_values ..."
      end
      # verify the required parameter 'list_name' is set
      fail ArgumentError, "Missing the required parameter 'list_name' when calling LOVApi.get_user_list_of_values" if list_name.nil?
      # resource path
      local_var_path = "/{listName}".sub('{format}','json').sub('{' + 'listName' + '}', list_name.to_s)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LOVApi#get_user_list_of_values\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
